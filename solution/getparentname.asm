...
_getparentname:     file format elf32-i386
  ...
  15:	8d 9d e8 fd ff ff    	lea    -0x218(%ebp),%ebx
{
  ...
  2c:	56                   	push   %esi
  2d:	53                   	push   %ebx
  2e:	e8 20 03 00 00       	call   353 <getparentname>
  33:	83 c4 10             	add    $0x10,%esp
  36:	85 c0                	test   %eax,%eax
  38:	75 05                	jne    3f <main+0x3f>

    exit();
  3a:	e8 74 02 00 00       	call   2b3 <exit>
    if (getparentname(parentbuf, childbuf, 256, 256)) printf(1, "XV6_TEST_OUTPUT Parent name: %s Child name: %s", parentbuf, childbuf);
  3f:	56                   	push   %esi
  40:	53                   	push   %ebx
  41:	68 38 07 00 00       	push   $0x738
  46:	6a 01                	push   $0x1
  48:	e8 c3 03 00 00       	call   410 <printf>
  4d:	83 c4 10             	add    $0x10,%esp
  50:	eb e8                	jmp    3a <main+0x3a>
  52:	66 90                	xchg   %ax,%ax
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 67 07 00 00       	mov    $0x767,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 78 0a 00 00    	mov    %edx,0xa78
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 78 0a 00 00    	mov    %edx,0xa78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 78 0a 00 00    	mov    0xa78,%edx
 ...
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 7c 0a 00 00       	mov    $0xa7c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 722:	00 00 00 
    if(p->s.size >= nunits){
