...
int main(int argc, char* argv[]) {
  ...
  if (getparentname((char*)0, child_name, MAX_NAME_LEN, MAX_NAME_LEN) < 0 &&
   e:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
int main(int argc, char* argv[]) {
  14:	81 ec 04 02 00 00    	sub    $0x204,%esp
  if (getparentname((char*)0, child_name, MAX_NAME_LEN, MAX_NAME_LEN) < 0 &&
  1a:	68 00 01 00 00       	push   $0x100
  1f:	68 00 01 00 00       	push   $0x100
  24:	50                   	push   %eax
  25:	6a 00                	push   $0x0
  27:	e8 47 03 00 00       	call   373 <getparentname>
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	85 c0                	test   %eax,%eax
  31:	78 14                	js     47 <main+0x47>
  ...
  36:	68 8c 07 00 00       	push   $0x78c
  3b:	6a 02                	push   $0x2
  3d:	e8 ee 03 00 00       	call   430 <printf>
  exit();
  42:	e8 8c 02 00 00       	call   2d3 <exit>
    getparentname(parent_name, (char*)0, MAX_NAME_LEN, MAX_NAME_LEN) < 0) {
  47:	8d 85 f8 fd ff ff    	lea    -0x208(%ebp),%eax
  4d:	68 00 01 00 00       	push   $0x100
  52:	68 00 01 00 00       	push   $0x100
  57:	6a 00                	push   $0x0
  59:	50                   	push   %eax
  5a:	e8 14 03 00 00       	call   373 <getparentname>
  if (getparentname((char*)0, child_name, MAX_NAME_LEN, MAX_NAME_LEN) < 0 &&
  5f:	83 c4 10             	add    $0x10,%esp
  62:	85 c0                	test   %eax,%eax
  64:	79 cd                	jns    33 <main+0x33>
    printf(1, "XV6_TEST_OUTPUT Null pointers handled correctly.\n");
  66:	50                   	push   %eax
  67:	50                   	push   %eax
  68:	68 58 07 00 00       	push   $0x758
  6d:	6a 01                	push   $0x1
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 d8 07 00 00 	jmp    *0x7d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba ce 07 00 00       	mov    $0x7ce,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 d8 0a 00 00    	mov    %edx,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 742:	00 00 00 
    if(p->s.size >= nunits){
