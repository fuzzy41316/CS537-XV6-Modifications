...
int main(void) 
{
  ...
  11:	e8 ed 02 00 00       	call   303 <getpid>
 ...
 33c:	89 d1                	mov    %edx,%ecx
{
 ...
 369:	0f b6 92 80 07 00 00 	movzbl 0x780(%edx),%edx
 ...
 3e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 459:	ff 24 85 28 07 00 00 	jmp    *0x728(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 567:	90                   	nop
          s = "(null)";
 568:	ba 1f 07 00 00       	mov    $0x71f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 581:	a1 28 0a 00 00       	mov    0xa28,%eax
{
 ...
 5c1:	5b                   	pop    %ebx
  freep = p;
 5c2:	89 15 28 0a 00 00    	mov    %edx,0xa28
}
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
 5ca:	5d                   	pop    %ebp
 ...
 5f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fc:	89 15 28 0a 00 00    	mov    %edx,0xa28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 3d 28 0a 00 00    	mov    0xa28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65f:	73 4f                	jae    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	8b 3d 28 0a 00 00    	mov    0xa28,%edi
 ...
 68a:	e8 f1 fe ff ff       	call   580 <free>
  return freep;
 68f:	8b 15 28 0a 00 00    	mov    0xa28,%edx
 ...
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	bf 2c 0a 00 00       	mov    $0xa2c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 6e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6eb:	c7 05 30 0a 00 00 00 	movl   $0x0,0xa30
 6f2:	00 00 00 
    if(p->s.size >= nunits){
