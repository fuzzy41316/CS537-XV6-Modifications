 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 08 08 00 00 	movzbl 0x808(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 b0 07 00 00 	jmp    *0x7b0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba a6 07 00 00       	mov    $0x7a6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 b8 0a 00 00    	mov    %edx,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 6fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 726:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 732:	00 00 00 
    if(p->s.size >= nunits){
