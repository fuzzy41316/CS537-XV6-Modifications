...
int main(int argc, char* argv[]) {
  ...
  if (getparentname(parent_name, child_name, empty_buffer_length, MAX_NAME_LEN) < 0 &&
   f:	8d b5 e8 fe ff ff    	lea    -0x118(%ebp),%esi
  15:	8d 9d e8 fd ff ff    	lea    -0x218(%ebp),%ebx
int main(int argc, char* argv[]) {
  1b:	51                   	push   %ecx
  ...
  29:	56                   	push   %esi
  2a:	53                   	push   %ebx
  2b:	e8 43 03 00 00       	call   373 <getparentname>
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	78 14                	js     4b <main+0x4b>
  ...
  3a:	68 90 07 00 00       	push   $0x790
  3f:	6a 02                	push   $0x2
  41:	e8 ea 03 00 00       	call   430 <printf>
  exit();
  46:	e8 88 02 00 00       	call   2d3 <exit>
    getparentname(parent_name, child_name, MAX_NAME_LEN, empty_buffer_length) < 0) {
  4b:	6a 00                	push   $0x0
  4d:	68 00 01 00 00       	push   $0x100
  52:	56                   	push   %esi
  53:	53                   	push   %ebx
  54:	e8 1a 03 00 00       	call   373 <getparentname>
  if (getparentname(parent_name, child_name, empty_buffer_length, MAX_NAME_LEN) < 0 &&
  59:	83 c4 10             	add    $0x10,%esp
  5c:	85 c0                	test   %eax,%eax
  5e:	79 d7                	jns    37 <main+0x37>
    printf(1, "XV6_TEST_OUTPUT Zero buffer length handled correctly.\n");
  60:	50                   	push   %eax
  61:	50                   	push   %eax
  62:	68 58 07 00 00       	push   $0x758
  67:	6a 01                	push   $0x1
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 38 08 00 00 	movzbl 0x838(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 e0 07 00 00 	jmp    *0x7e0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba d7 07 00 00       	mov    $0x7d7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 e8 0a 00 00       	mov    0xae8,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 e8 0a 00 00    	mov    %edx,0xae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d e8 0a 00 00    	mov    0xae8,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf ec 0a 00 00       	mov    $0xaec,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 742:	00 00 00 
    if(p->s.size >= nunits){
